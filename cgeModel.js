...
// ─── Макроэкономические параметры Таджикистана (2019) ───────────────────────
const MACRO = {
  remit_gdp:   0.28,   // денежные переводы / ВВП ≈ 28%
  gov_gdp:     0.30,   // госрасходы / ВВП ≈ 30%
  export_gdp:  0.22,   // экспорт / ВВП ≈ 22%
  import_gdp:  0.42,   // импорт / ВВП ≈ 42%
  multiplier:  1.25,   // фискальный мультипликатор (для открытой малой экономики)
  fx_pass:     0.35,   // коэффициент переноса курса на цены
};
